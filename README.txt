...
//เพิ่มอัพเดตข้อมูล ใน github
# 1. เพิ่มไฟล์ทั้งหมดที่มีการเปลี่ยนแปลง รวมถึงไฟล์ใหม่
git add .

# 2. สร้าง commit พร้อมข้อความ
git commit -m ""

# 3. ส่งขึ้น GitHub บน branch main
